...
def parse_qcom_ephem(qcom_poly, current_week):
  ...
  poly_data['deg'] = 3
  poly_data['deg_t'] = 3
  # ephemeris is 180seconds old when received, increase by 2min, as new ephemeris
  # is received every 100seconds (20seconds more for safety)
  return PolyEphemeris(prn, poly_data, epoch, ephem_type=EphemerisType.QCOM_POLY, max_time_diff=(180+120))
